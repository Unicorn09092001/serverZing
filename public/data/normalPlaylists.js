		...
		playlists: [
			{
				...
				description: 'Những đóa hồng tạo nên dấu ấn trên thị trường âm nhạc Việt hiện nay',
				image: 'assets/img/tabExplore/normalPlaylists/playlistList2/playlist1.jpg',
			},
			{
				name: 'V-Pop Rising',
				description: 'Những tài năng Gen Z của V-Pop đáng nghe nhất hôm nay',
				image: 'assets/img/tabExplore/normalPlaylists/playlistList2/playlist2.jpg',
			},
			{
				name: 'Everyday EDM',
				description: 'Khởi động mỗi ngày với những ca khúc EDM sôi động',
				image: 'assets/img/tabExplore/normalPlaylists/playlistList2/playlist3.jpg',
			},
			{
				name: 'K-Pop Newbie',
				description: 'Những hạt giống tiềm năng của K-Pop thế hệ mới',
				image: 'assets/img/tabExplore/normalPlaylists/playlistList2/playlist4.jpg',
			},
			{
				name: 'Anime Now',
				description: 'Nhạc Anime hot nhất ở thời điểm hiện tại có ngay tại đây',
				image: 'assets/img/tabExplore/normalPlaylists/playlistList2/playlist5.jpg',
			},
		],
	},
	{
		...
		playlists: [
			{
				name: 'New Releases',
				description: 'Những ca khúc tạo nên xu hướng âm nhạc mới!',
				image: 'assets/img/tabExplore/normalPlaylists/playlistList3/playlist1.jpg',
			},
			{
				name: "Today's Electronic",
				description: 'Cuồng nhiệt, đầy mê hoặc với giai điệu Electronic',
				image: 'assets/img/tabExplore/normalPlaylists/playlistList3/playlist2.jpg',
			},
			{
				name: "XONE's Picks",
				description: 'Top ca khúc XONE chọn riêng cho hôm nay',
				image: 'assets/img/tabExplore/normalPlaylists/playlistList3/playlist3.jpg',
			},
			{
				name: "Lany's Flavour",
				description: 'Thưởng thức âm nhạc từ nghệ sỹ bạn yêu thích',
				image: 'assets/img/tabExplore/normalPlaylists/playlistList3/playlist4.jpg',
			},
			{
				name: 'Asia Tune',
				description: 'Bài hát tuyển chọn cho người chơi hệ châu Á',
				image: 'assets/img/tabExplore/normalPlaylists/playlistList3/playlist5.jpg',
			},
		],
	},
	{
		...
		playlists: [
			{
				...
				image: 'assets/img/tabExplore/normalPlaylists/playlistList4/playlist1.jfif',
			},
			{
				name: '',
				artists: ['Jack', 'Uyên Linh', 'Tino'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList4/playlist2.jfif',
			},
			{
				name: '',
				artists: ['MCK', 'tlinh', 'Khắc Hưng'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList4/playlist3.jfif',
			},
			{
				name: '',
				artists: ['Rhymastic', 'Phương Ly', 'Touliver'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList4/playlist4.jfif',
			},
			{
				name: '',
				artists: ['Hương Ly', 'Huy Nam (A#)', 'Trúc Nhân'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList4/playlist5.jfif',
			},
		],
	},
	{
		...
		playlists: [
			{
				...
				image: 'assets/img/tabExplore/normalPlaylists/playlistList5/playlist1.jpg',
			},
			{
				name: 'Nhạc Âu Mỹ Tháng 10/2021',
				artists: ['Jeremy Zucker', 'Lil Nas X', 'Nicki Minaj'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList5/playlist2.jpg',
			},
			{
				name: 'Nhạc Hàn Tháng 10/2021',
				artists: ['CL', 'aespa', 'Key'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList5/playlist3.jpg',
			},
			{
				name: 'Nhạc Hoa Tháng 10/2021',
				artists: ['Trình Hưởng', 'PANTHEPACK', 'Sunnee Dương Vân Tình'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList5/playlist4.jpg',
			},
			{
				name: 'Indie Việt Tháng 10/2021',
				artists: ['Duongg', 'Starry Night', 'Charles Huỳnh'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList5/playlist5.jpg',
			},
		],
	},
	{
		...
		playlists: [
			{
				...
				artists: ['Huy Vạc'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList7/playlist1.jpg',
			},
			{
				name: 'Ôm Trọn Nỗi Đau (Single)',
				artists: ['Tino', 'Lưu Hiền Trinh'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList7/playlist2.jpg',
			},
			{
				name: 'Bao Lâu Ta Lại Yêu Một Người (Lofi Version) (Single)',
				artists: ['Doãn Hiếu'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList7/playlist3.jpg',
			},
			{
				name: 'vâng anh đi đi (liu riu version) (Single)',
				artists: ['Bích Phương'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList7/playlist4.jpg',
			},
			{
				name: 'Đêm Mưa (Single)',
				artists: ['Duy Ngọc'],
				image: 'assets/img/tabExplore/normalPlaylists/playlistList7/playlist5.jpg',
			},
		],
	},
	{
